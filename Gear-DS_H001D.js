import{_ as zt,g as Kt,a as qn,b as Gn,d as Be,c as h,e as Je,p as zn,E as Xe,f as v,h as Kn,j as I,k as $n,S as he,q as J,l as Bn,m as jn,L as Yn,n as $t,o as Jn,F as Qe,s as Xn,t as te,u as ne,v as Qn,w as Et,C as Tt,r as wt,x as Zn}from"./index.esm-B891aqz_.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pe=new Yn("@firebase/auth");function ni(n,...e){Pe.logLevel<=$t.WARN&&Pe.warn(`Auth (${he}): ${n}`,...e)}function we(n,...e){Pe.logLevel<=$t.ERROR&&Pe.error(`Auth (${he}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ae(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function tt(){return yt()==="http:"||yt()==="https:"}function yt(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ii(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(tt()||Jn()||"connection"in navigator)?navigator.onLine:!0}function ri(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fe{constructor(e,t){this.shortDelay=e,this.longDelay=t,C(t>e,"Short delay should be less than long delay!"),this.isMobile=Bn()||jn()}get(){return ii()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nt(n,e){C(n.emulator,"Emulator should always be set here");const{url:t}=n.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oi=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],ai=new fe(3e4,6e4);function p(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function m(n,e,t,i,r={}){return Jt(n,r,async()=>{let s={},o={};i&&(e==="GET"?o=i:s={body:JSON.stringify(i)});const a=J({key:n.config.apiKey,...o}).slice(1),c=await n._getAdditionalHeaders();c["Content-Type"]="application/json",n.languageCode&&(c["X-Firebase-Locale"]=n.languageCode);const l={method:e,headers:c,...s};return Qn()||(l.referrerPolicy="no-referrer"),n.emulatorConfig&&Je(n.emulatorConfig.host)&&(l.credentials="include"),Yt.fetch()(await Xt(n,n.config.apiHost,t,a),l)})}async function Jt(n,e,t){n._canInitEmulator=!1;const i={...si,...e};try{const r=new ui(n),s=await Promise.race([t(),r.promise]);r.clearNetworkTimeout();const o=await s.json();if("needConfirmation"in o)throw ie(n,"account-exists-with-different-credential",o);if(s.ok&&!("errorMessage"in o))return o;{const a=s.ok?o.errorMessage:o.error.message,[c,l]=a.split(" : ");if(c==="FEDERATED_USER_ID_ALREADY_LINKED")throw ie(n,"credential-already-in-use",o);if(c==="EMAIL_EXISTS")throw ie(n,"email-already-in-use",o);if(c==="USER_DISABLED")throw ie(n,"user-disabled",o);const d=i[c]||c.toLowerCase().replace(/[_\s]+/g,"-");if(l)throw Ze(n,d,l);y(n,d)}}catch(r){if(r instanceof Qe)throw r;y(n,"network-request-failed",{message:String(r)})}}async function L(n,e,t,i,r={}){const s=await m(n,e,t,i,r);return"mfaPendingCredential"in s&&y(n,"multi-factor-auth-required",{_serverResponse:s}),s}async function Xt(n,e,t,i){const r=`${e}${t}?${i}`,s=n,o=s.config.emulator?nt(n.config,r):`${n.config.apiScheme}://${r}`;return oi.includes(t)&&(await s._persistenceManagerAvailable,s._getPersistenceType()==="COOKIE")?s._getPersistence()._getFinalTarget(o).toString():o}function ci(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class ui{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(w(this.auth,"network-request-failed")),ai.get())})}}function ie(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const r=w(n,e,i);return r.customData._tokenResponse=t,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function li(n){return(await m(n,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}async function Zt(n,e){return m(n,"GET","/v2/recaptchaConfig",p(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _i(n,e){const t=await Jt(n,{},async()=>{const i=J({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=n.config,o=await Xt(n,r,"/v1/token",`key=${s}`),a=await n._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:i};return n.emulatorConfig&&Je(n.emulatorConfig.host)&&(c.credentials="include"),Yt.fetch()(o,c)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Ei(n,e){return m(n,"POST","/v2/accounts:revokeToken",p(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pt=new Map;function S(n){C(n instanceof Function,"Expected a class definition");let e=Pt.get(n);return e?(C(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Pt.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kt(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(on(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(nn(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(cn(e))return"Blackberry";if(un(e))return"Webos";if(rn(e))return"Safari";if((e.includes("chrome/")||sn(e))&&!e.includes("edge/"))return"Chrome";if(an(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function nn(n=v()){return/firefox\//i.test(n)}function rn(n=v()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function sn(n=v()){return/crios\//i.test(n)}function on(n=v()){return/iemobile/i.test(n)}function an(n=v()){return/android/i.test(n)}function cn(n=v()){return/blackberry/i.test(n)}function un(n=v()){return/webos/i.test(n)}function it(n=v()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Ti(n=v()){var e;return it(n)&&!!((e=window.navigator)!=null&&e.standalone)}function wi(){return Kn()&&document.documentMode===10}function ln(n=v()){return it(n)||an(n)||un(n)||cn(n)||/windows phone/i.test(n)||on(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dn(n,e=[]){let t;switch(n){case"Browser":t=kt(v());break;case"Worker":t=`${kt(v())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${he}/${i}`}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gn(n,e){return m(n,"POST","/v1/accounts:resetPassword",p(n,e))}async function zi(n,e){return m(n,"POST","/v1/accounts:update",e)}async function Ki(n,e){return m(n,"POST","/v1/accounts:signUp",e)}async function $i(n,e){return m(n,"POST","/v1/accounts:update",p(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function In(n,e){return L(n,"POST","/v1/accounts:signUp",p(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class A{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,t,i,r=!1){const s=await R._fromIdTokenResponse(e,i,r),o=bt(i);return new A({user:s,providerId:o,_tokenResponse:i,operationType:t})}static async _forOperation(e,t,i){await e._updateTokensIfNecessary(i,!0);const r=bt(i);return new A({user:e,providerId:r,_tokenResponse:i,operationType:t})}}function bt(n){return n.providerId?n.providerId:"phoneNumber"in n?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function En(n){return new Set(n.map(({providerId:e})=>e).filter(e=>!!e))}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ro(n,e){const t=h(n);await Le(!0,t,e);const{providerUserInfo:i}=await hi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=En(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function st(n,e,t=!1){const i=await O(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function Le(n,e,t){await ce(e);const i=En(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";u(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wn(n,e,t=!1){if(I(n.app))return Promise.reject(T(n));const i="signIn",r=await _n(n,i,e),s=await A._fromIdTokenResponse(n,i,r);return t||await n._updateCurrentUser(s.user),s}async function ot(n,e){return wn(_(n),e)}async function ur(n,e){const t=h(n);return await Le(!1,t,e.providerId),st(t,e)}async function lr(n,e){return Tn(h(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ie{constructor(e,t){this.factorId=e,this.uid=t.mfaEnrollmentId,this.enrollmentTime=new Date(t.enrolledAt).toUTCString(),this.displayName=t.displayName}static _fromServerResponse(e,t){return"phoneInfo"in t?at._fromServerResponse(e,t):"totpInfo"in t?ct._fromServerResponse(e,t):y(e,"internal-error")}}class at extends Ie{constructor(e){super("phone",e),this.phoneNumber=e.phoneInfo}static _fromServerResponse(e,t){return new at(t)}}class ct extends Ie{constructor(e){super("totp",e)}static _fromServerResponse(e,t){return new ct(t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ut(n){const e=_(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function oo(n,e,t){const i=_(n),r={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&De(i,r,t),await H(i,r,"getOobCode",Yi,"EMAIL_PASSWORD_PROVIDER")}async function ao(n,e,t){await gn(h(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&ut(n),i})}async function co(n,e){await $i(h(n),{oobCode:e})}async function hr(n,e){const t=h(n),i=await gn(t,{oobCode:e}),r=i.requestType;switch(u(r,t,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":u(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":u(i.mfaInfo,t,"internal-error");default:u(i.email,t,"internal-error")}let s=null;return i.mfaInfo&&(s=Ie._fromServerResponse(_(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function uo(n,e){const{data:t}=await hr(h(n),e);return t.email}async function lo(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=_(n),o=await H(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",In,"EMAIL_PASSWORD_PROVIDER").catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&ut(n),c}),a=await A._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function ho(n,e,t){return I(n.app)?Promise.reject(T(n)):ot(h(n),G.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&ut(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(n){var r,s;if(!n)return null;const{providerId:e}=n,t=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},i=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&(n!=null&&n.idToken)){const o=(s=(r=Oe(n.idToken))==null?void 0:r.firebase)==null?void 0:s.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new j(i,a)}}if(!e)return null;switch(e){case"facebook.com":return new gr(i,t);case"github.com":return new Ir(i,t);case"google.com":return new _r(i,t);case"twitter.com":return new Er(i,t,n.screenName||null);case"custom":case"anonymous":return new j(i,null);default:return new j(i,e,t)}}class j{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class vn extends j{constructor(e,t,i,r){super(e,t,i),this.username=r}}class gr extends j{constructor(e,t){super(e,"facebook.com",t)}}class Ir extends vn{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class _r extends j{constructor(e,t){super(e,"google.com",t)}}class Er extends vn{constructor(e,t,i){super(e,"twitter.com",t,i)}}function yo(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:mr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class An{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Ne,"1"),this.storage.removeItem(Ne),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn extends An{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Sn.type="SESSION";const kn=Sn;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ht(){return typeof E().WorkerGlobalScope<"u"&&typeof E().importScripts=="function"}async function Lr(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Dr(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function Mr(){return ht()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(n,e){return m(n,"POST","/v2/accounts/mfaSignIn:start",p(n,e))}function qr(n,e){return m(n,"POST","/v2/accounts/mfaSignIn:finalize",p(n,e))}function Gr(n,e){return m(n,"POST","/v2/accounts/mfaSignIn:finalize",p(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze=hn("rcb"),zr=new fe(3e4,6e4);class Kr{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!((e=E().grecaptcha)!=null&&e.render)}load(e,t=""){return u($r(t),e,"argument-error"),this.shouldResolveImmediately(t)&&vt(E().grecaptcha)?Promise.resolve(E().grecaptcha):new Promise((i,r)=>{const s=E().setTimeout(()=>{r(w(e,"network-request-failed"))},zr.get());E()[ze]=()=>{E().clearTimeout(s),delete E()[ze];const a=E().grecaptcha;if(!a||!vt(a)){r(w(e,"internal-error"));return}const c=a.render;a.render=(l,d)=>{const f=c(l,d);return this.counter++,f},this.hostLanguage=t,i(a)};const o=`${ki()}?${J({onload:ze,render:"explicit",hl:t})}`;rt(o).catch(()=>{clearTimeout(s),r(w(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!((t=E().grecaptcha)!=null&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function $r(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class Br{async load(e){return new Li(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ft{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=q._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function Uo(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=_(n),r=await Fe(i,e,h(t));return new ft(r,s=>ot(i,s))}async function Vo(n,e,t){const i=h(n);await Le(!1,i,"phone");const r=await Fe(i.auth,e,h(t));return new ft(r,s=>ur(i,s))}async function Fo(n,e,t){const i=h(n);if(I(i.auth.app))return Promise.reject(T(i.auth));const r=await Fe(i.auth,e,h(t));return new ft(r,s=>lr(i,s))}async function Fe(n,e,t){var i;if(!n._getRecaptchaConfig())try{await pn(n)}catch{console.log("Failed to initialize reCAPTCHA Enterprise config. Triggering the reCAPTCHA v2 verification.")}try{let r;if(typeof e=="string"?r={phoneNumber:e}:r=e,"session"in r){const s=r.session;if("phoneNumber"in r){u(s.type==="enroll",n,"internal-error");const o={idToken:s.credential,phoneEnrollmentInfo:{phoneNumber:r.phoneNumber,clientType:"CLIENT_TYPE_WEB"}};return(await H(n,o,"mfaSmsEnrollment",async(d,f)=>{if(f.phoneEnrollmentInfo.captchaResponse===se){u((t==null?void 0:t.type)===oe,d,"argument-error");const g=await Ke(d,f,t);return Lt(d,g)}return Lt(d,f)},"PHONE_PROVIDER").catch(d=>Promise.reject(d))).phoneSessionInfo.sessionInfo}else{u(s.type==="signin",n,"internal-error");const o=((i=r.multiFactorHint)==null?void 0:i.uid)||r.multiFactorUid;u(o,n,"missing-multi-factor-info");const a={mfaPendingCredential:s.credential,mfaEnrollmentId:o,phoneSignInInfo:{clientType:"CLIENT_TYPE_WEB"}};return(await H(n,a,"mfaSmsSignIn",async(f,g)=>{if(g.phoneSignInInfo.captchaResponse===se){u((t==null?void 0:t.type)===oe,f,"argument-error");const K=await Ke(f,g,t);return Ut(f,K)}return Ut(f,g)},"PHONE_PROVIDER").catch(f=>Promise.reject(f))).phoneResponseInfo.sessionInfo}}else{const s={phoneNumber:r.phoneNumber,clientType:"CLIENT_TYPE_WEB"};return(await H(n,s,"sendVerificationCode",async(l,d)=>{if(d.captchaResponse===se){u((t==null?void 0:t.type)===oe,l,"argument-error");const f=await Ke(l,d,t);return Ot(l,f)}return Ot(l,d)},"PHONE_PROVIDER").catch(l=>Promise.reject(l))).sessionInfo}}finally{t==null||t._reset()}}async function xo(n,e){const t=h(n);if(I(t.auth.app))return Promise.reject(T(t.auth));await st(t,e)}async function Ke(n,e,t){u(t.type===oe,n,"argument-error");const i=await t.verify();u(typeof i=="string",n,"argument-error");const r={...e};if("phoneEnrollmentInfo"in r){const s=r.phoneEnrollmentInfo.phoneNumber,o=r.phoneEnrollmentInfo.captchaResponse,a=r.phoneEnrollmentInfo.clientType,c=r.phoneEnrollmentInfo.recaptchaVersion;return Object.assign(r,{phoneEnrollmentInfo:{phoneNumber:s,recaptchaToken:i,captchaResponse:o,clientType:a,recaptchaVersion:c}}),r}else if("phoneSignInInfo"in r){const s=r.phoneSignInInfo.captchaResponse,o=r.phoneSignInInfo.clientType,a=r.phoneSignInInfo.recaptchaVersion;return Object.assign(r,{phoneSignInInfo:{recaptchaToken:i,captchaResponse:s,clientType:o,recaptchaVersion:a}}),r}else return Object.assign(r,{recaptchaToken:i}),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pt extends me{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return N(e,this._buildIdpRequest())}_linkToIdToken(e,t){return N(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return N(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Jr(n){return wn(n.auth,new pt(n),n.bypassAuthState)}function Xr(n){const{auth:e,user:t}=n;return u(t,e,"internal-error"),Tn(t,new pt(n),n.bypassAuthState)}async function Qr(n){const{auth:e,user:t}=n;return u(t,e,"internal-error"),st(t,new pt(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ms=new fe(3e4,6e4);function Ft(){const n=E().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function gs(n){return new Promise((e,t)=>{var r,s,o;function i(){Ft(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ft(),t(w(n,"network-request-failed"))},timeout:ms.get()})}if((s=(r=E().gapi)==null?void 0:r.iframes)!=null&&s.Iframe)e(gapi.iframes.getContext());else if((o=E().gapi)!=null&&o.load)i();else{const a=hn("iframefcb");return E()[a]=()=>{gapi.load?i():t(w(n,"network-request-failed"))},rt(`${Ci()}?onload=${a}`).catch(c=>t(c))}}).catch(e=>{throw Re=null,e})}let Re=null;function Is(n){return Re=Re||gs(n),Re}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rs={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Ps=500,Ss=600,ks="_blank",Ns="http://localhost";class xt{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Cs(n,e,t,i=Ps,r=Ss){const s=Math.max((window.screen.availHeight-r)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c={...Rs,width:i.toString(),height:r.toString(),top:s,left:o},l=v().toLowerCase();t&&(a=sn(l)?ks:t),nn(l)&&(e=e||Ns,c.scrollbars="yes");const d=Object.entries(c).reduce((g,[K,Z])=>`${g}${K}=${Z},`,"");if(Ti(l)&&a!=="_self")return Os(e||"",a),new xt(null);const f=window.open(e||"",a,d);u(f,n,"popup-blocked");try{f.focus()}catch{}return new xt(f)}function Os(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $e="webStorageSupport";class Us{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=kn,this._completeRedirectFn=Un,this._overrideRedirectResult=is}async _openPopup(e,t,i,r){var o;C((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const s=await Ht(e,t,i,ae(),r);return Cs(e,s,Ue())}async _openRedirect(e,t,i,r){await this._originValidation(e);const s=await Ht(e,t,i,ae(),r);return br(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:r,promise:s}=this.eventManagers[t];return r?Promise.resolve(r):(C(s,"If manager is not set, promise should be"),s)}const i=this.initAndGetManager(e);return this.eventManagers[t]={promise:i},i.catch(()=>{delete this.eventManagers[t]}),i}async initAndGetManager(e){const t=await As(e),i=new cs(e);return t.register("authEvent",r=>(u(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:i.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=t,i}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send($e,{type:$e},r=>{var o;const s=(o=r==null?void 0:r[0])==null?void 0:o[$e];s!==void 0&&t(!!s),y(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=fs(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ln()||rn()||it()}}const Vs=Us;class xn{constructor(e){this.factorId=e}_process(e,t,i){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,i);case"signin":return this._finalizeSignIn(e,t.credential);default:return P("unexpected MultiFactorSessionType")}}}class gt extends xn{constructor(e){super("phone"),this.credential=e}static _fromCredential(e){return new gt(e)}_finalizeEnroll(e,t,i){return yr(e,{idToken:t,displayName:i,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,t){return qr(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}class Fs{constructor(){}static assertion(e){return gt._fromCredential(e)}}Fs.FACTOR_ID="phone";class xs{static assertionForEnrollment(e,t){return de._fromSecret(e,t)}static assertionForSignIn(e,t){return de._fromEnrollmentId(e,t)}static async generateSecret(e){var r;const t=e;u(typeof((r=t.user)==null?void 0:r.auth)<"u","internal-error");const i=await vr(t.user.auth,{idToken:t.credential,totpEnrollmentInfo:{}});return It._fromStartTotpMfaEnrollmentResponse(i,t.user.auth)}}xs.FACTOR_ID="totp";class de extends xn{constructor(e,t,i){super("totp"),this.otp=e,this.enrollmentId=t,this.secret=i}static _fromSecret(e,t){return new de(t,void 0,e)}static _fromEnrollmentId(e,t){return new de(t,e)}async _finalizeEnroll(e,t,i){return u(typeof this.secret<"u",e,"argument-error"),Ar(e,{idToken:t,displayName:i,totpVerificationInfo:this.secret._makeTotpVerificationInfo(this.otp)})}async _finalizeSignIn(e,t){u(this.enrollmentId!==void 0&&this.otp!==void 0,e,"argument-error");const i={verificationCode:this.otp};return Gr(e,{mfaPendingCredential:t,mfaEnrollmentId:this.enrollmentId,totpVerificationInfo:i})}}class It{constructor(e,t,i,r,s,o,a){this.sessionInfo=o,this.auth=a,this.secretKey=e,this.hashingAlgorithm=t,this.codeLength=i,this.codeIntervalSeconds=r,this.enrollmentCompletionDeadline=s}static _fromStartTotpMfaEnrollmentResponse(e,t){return new It(e.totpSessionInfo.sharedSecretKey,e.totpSessionInfo.hashingAlgorithm,e.totpSessionInfo.verificationCodeLength,e.totpSessionInfo.periodSec,new Date(e.totpSessionInfo.finalizeEnrollmentTime).toUTCString(),e.totpSessionInfo.sessionInfo,t)}_makeTotpVerificationInfo(e){return{sessionInfo:this.sessionInfo,verificationCode:e}}generateQrCodeUrl(e,t){var r;let i=!1;return(Te(e)||Te(t))&&(i=!0),i&&(Te(e)&&(e=((r=this.auth.currentUser)==null?void 0:r.email)||"unknownuser"),Te(t)&&(t=this.auth.name)),`otpauth://totp/${t}:${e}?secret=${this.secretKey}&issuer=${t}&algorithm=${this.hashingAlgorithm}&digits=${this.codeLength}`}}function Te(n){return typeof n>"u"||(n==null?void 0:n.length)===0}var Wt="@firebase/auth",qt="1.13.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function qs(n){Et(new Tt("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;u(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const c={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:dn(n)},l=new Pi(i,r,s,c);return Hi(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),Et(new Tt("auth-internal",e=>{const t=_(e.getProvider("auth").getImmediate());return(i=>new Hs(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),wt(Wt,qt,Ws(n)),wt(Wt,qt,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
